...
def train_bert():
	...
	with torch.cuda.device(cuda):
		for traincv, testcv in cv_data:
			...
			# print(train_essays)
			tokenized_train = train_essays.apply((lambda x: tokenizer.encode(x, add_special_tokens=True, max_length=40)))
			tokenized_test = test_essays.apply((lambda x: tokenizer.encode(x, add_special_tokens=True, max_length=40)))
